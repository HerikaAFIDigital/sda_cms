...
const line1 = "The certification test has been developed to resemble real life clinical situations and is a comprehensive case-based test.";
const line2 = "This certificate is granted for successful completion of the certification test in the Safe Delivery App.";
const line3 = "This certification is a proof of proficient knowledge on the 7 Basic Emergency Obstetric and Neonatal care Signal Functions.";
...
async function renderCertificate(profile: IProfile) {
    ...
    context.font = "italic normal 64px 'Fanwood Text'";
