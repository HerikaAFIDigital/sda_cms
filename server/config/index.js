...
const env = "dev"; //set for dev environment for local testing
//const env = "production"; //set for prod environment for local testing
...
const config = {
  ...
  //Commented for local testing, below pointing to actual service on Azure
  apkService: {
    apiKey: "gQzB7EwqGsrrPpWrxl9F1toCnNAOKW1vKyf3B1ZOXzY5HyTUV0",
    host: "sdacms-duration.westeurope.cloudapp.azure.com",
    port: 3020,
  },
  //pointing to local apk service
  /*apkService: {
    apiKey: "gQzB7EwqGsrrPpWrxl9F1toCnNAOKW1vKyf3B1ZOXzY5HyTUV0",
    host: "localhost",
    port: 3020,
